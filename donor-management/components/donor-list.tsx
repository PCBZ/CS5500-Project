...
interface Donor {
  ...
  status: "pending" | "approved" | "excluded" | "auto-excluded"
  notes?: string
}
...
export default function DonorList() {
  ...
  const handleApprove = (id: string) => {
    setDonors(donors.map((donor) => (donor.id === id ? { ...donor, status: "approved" as const } : donor)))
  }

  const handleExclude = (id: string) => {
    setDonors(donors.map((donor) => (donor.id === id ? { ...donor, status: "excluded" as const } : donor)))
  }
